                    ...
                    <div class="about" style="height:auto;">\
                        ...
                        <div class="content">\
                            ...
                            <p className="desc">\
                                ...
                                除此以外，简 Tab 还拥有自己的 <code>精选集</code>；如同 iPhone 上的壁纸类 App 一样，通过 <code>人工筛选</code> 的方式进一步将适合作为 New Tab 背景的壁纸呈现给你；这也是与其它同类扩展最大的不同。<br>\
                                如果你有 <code>好的作品</code> 亦或 <code>适合的背景</code>，也请告诉 简 Tab，投稿地址 👉 <a href="" target="_blank">猛戳这里</a> · <a href="" target="_blank">备用地址</a> <br><br>\
