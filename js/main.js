...
function tooltips( id ) {
    var steps  = {
        origins: '<div class="title">支持从多个壁纸源获取数据</div><div>必应每日图片 · 必应随机图片 · wallhaven.cc · unsplash.com · googleartproject.com · desktoppr.co · visualhunt.com</div><a class="learnmore" href="https://simptab.art/docs/#/%E8%83%8C%E6%99%AF%E6%BA%90?id=%e5%a4%9a%e7%a7%8d%e8%83%8c%e6%99%af%e6%ba%90" target="_blank">多种背景源</a>',
        positionmode: '<div class="title">具有多种方式的壁纸更换模式</div><div><ul><li>每天更换背景<br><abbr>每天更换一次，背景源只来源于 必应每日图片</abbr></li><li>随机更换</li><li>只显示当前背景</li><li>地球每刻</li></ul><a class="learnmore" href="https://simptab.art/docs/#/%E8%83%8C%E6%99%AF%E6%BA%90?id=%e5%a4%9a%e7%a7%8d%e8%83%8c%e6%99%af%e6%ba%90" target="_blank">背景更换模式</a>',
        controlbar: '<div class="title">直观的控制栏，包含多种操作方案</div><div class="details"><ul><li>上传 · 下载</li><li>收藏</li><li>固定</li><li>下一张（刷新）</li><li>不喜欢</li></ul></div><a class="learnmore" href="https://simptab.art/docs/#/%E6%8E%A7%E5%88%B6%E6%A0%8F" target="_blank">控制栏</a>',
        unsplash: '<div class="title">深度集成 Unsplash 源的定制化设置</div><div class="details"><ul><li>自定义 Unsplash 源</li><li>更改 Unsplash 源分辨率</li></ul><a class="learnmore" href="https://simptab.art/docs/#/%E8%83%8C%E6%99%AF%E6%BA%90?id=%e8%87%aa%e5%ae%9a%e4%b9%89unsplash%e6%ba%90" target="_blank">自定义 Unsplash 源</a>'
    };
