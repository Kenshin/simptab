...
$( document ).ready( function() {
    ...
    i18n.init( options, function( t ) {
        ...
        $(".footer li:nth-child(1) nav div:nth-of-type(1)").html( t( "feedback" ));
        $(".footer li:nth-child(1) nav div:nth-of-type(2) span:nth-of-type(1)").html( t( "contact" ));
        $(".footer li:nth-child(1) nav div:nth-of-type(2) a:nth-of-type(2)").html( t( "author" ).toLowerCase() );
        $(".footer li:nth-child(1) nav div:nth-of-type(2) span:nth-of-type(2)").html( t( "end" ).toLowerCase() );
