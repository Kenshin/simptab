            ...
            var key      = "simptab-options",
                _storage = {
                    ...
                    search: [
                        ...
                        '{"key":"wx", "color": "#1AAD19", "title":"微信搜素",    "query": "https://weixin.sogou.com/weixin?type=2&s_from=input&query={query}"}',
                        '{"key":"z",  "color": "#0084FF", "title":"知乎搜素",    "query": "http://zhihu.sogou.com/zhihu?query={query}"}',
