...
define([ "jquery" ], function( $ ) {
    ...
    *
    * type include: `default` `bing.com` `wallhaven.cc` `unsplash.it` `unsplash.com` `flickr.com` `googleartproject.com` `500px.com` `desktoppr.co` `visualhunt.com` `special` `upload`
    *
    * when version = 2.1
