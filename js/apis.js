    ...
    */
    apis.Stack[ apis.ORIGINS[12] ] = function() {
        ...
        try {
            ...
            apis.defer.resolve( url, url, "Bing.com Image", "#", date.Now(), "Bing.com Image", apis.vo.origin, apis.vo );
        }
        catch ( error ) {
            apis.defer.reject( new SimpError( apis.vo.method, "Parse bing.com image error.", apis.vo ), error );
        }
      return apis.defer.promise();
    }
