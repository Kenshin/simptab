  ...
  grunt.initConfig({
    ...
    copy: {
      publish: {
        files: [{
            expand: true,
            src: [ "_locales/**", "assets/**", "!assets/**/*.woff", "vender/require.js", "manifest.json", "vender/waves/waves.min.css", "vender/notify/notify.min.css", "vender/balloon.min.css", "vender/carousel/carousel.css" ],
            dest: "dest-extension"
          }]
      }
    },
